      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <SignUp.Root>
          <SignUp.Step name="start" className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Clerk.Field name="username" className="flex flex-col gap-2 ">
                <Clerk.Input
                  className="py-2 px-6 rounded-full text-white w-72 placeholder:text-sm border-white"
                  placeholder="Username"
                />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>
              <Clerk.Field name="emailAddress" className="flex flex-col gap-2 border-[#e7e9ea]">
                <Clerk.Input
                  className="py-2 px-6 rounded-full text-white w-72 placeholder:text-sm border-[#e7e9ea] border-[#e7e9ea]"
                  placeholder="E-mail"
                />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>
              <Clerk.Field name="password" className="flex flex-col gap-2 border-[#e7e9ea]">
                <Clerk.Input
                  className="py-2 px-6 rounded-full text-white w-72 placeholder:text-sm border-[#e7e9ea]"
              ...
              <SignUp.Action
                submit
                className="bg-[#1d9bf0] rounded-full p-2 text-white font-bold w-72 text-center "
              >
                Sign up
              </SignUp.Action>
            </div>
          ...
          <SignUp.Step name="continue" className="flex flex-col gap-4">
            ...
            <SignUp.Action submit className="w-72 text-center text-[#1d9bf0] underline">Continue</SignUp.Action>
          </SignUp.Step>
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              ...
              <SignUp.Action
                submit
                className="mt-2 underline text-[#1d9bf0] text-sm"
              >
                Verify
              </SignUp.Action>
            </SignUp.Strategy>
          ...
          <div className="w-72 flex items-center gap-4">
            <div className="h-px bg-[#2f3336] flex-grow"></div>
            <span className="text-[#e7e9ea]">or</span>
            <div className="h-px bg-[#2f3336] flex-grow"></div>
          </div>
          <Link
            href="/sign-in"
