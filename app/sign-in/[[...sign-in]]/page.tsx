        ...
        <h1 className="text-2xl ">Join today.</h1>
          ...
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                <SignIn.Action
                  submit
                  className="mt-2 text-sm underline w-72 text-center text-[#1d9bf0]"
                >
                  Continue
                </SignIn.Action>
                <SignIn.Action
          ...
          >
            <SignIn.SupportedStrategy name="reset_password_email_code">
              <span className="underline text-[#1d9bf0]">Reset password</span>
          ...
          <p className="w-72 text-xs">
            By signing up, you agree to the <span className="text-[#1d9bf0]">Terms of Service</span> and <span className="text-[#1d9bf0]">Privacy Policy</span>,
