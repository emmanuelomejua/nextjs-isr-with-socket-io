...
const ImageEditor = ({ previewURL, onClose, settings, setSettings}: EType) => {
  ...
  return (
    <div className='absolute w-screen h-screen overflow-y-scroll left-0 top-0 bg-black opacity-90 z-10 flex items-center justify-center'>
        <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
            ...
            {/* Image */}
             <div className="w-[450px] h-[400px] flex items-center">
